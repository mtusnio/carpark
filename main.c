...
#define BOOTSTRAP_SERVER_URI "coap://[fe80::219:f5ff:fe89:bfc]:15683"
...
static void DefineObjects(AwaStaticClient * client)
{
    ...
    AwaStaticClient_DefineResource(client, 1337, 1, "Temperature", AwaResourceType_Integer, 0, 1, AwaResourceOperations_ReadOnly);
